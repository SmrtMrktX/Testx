...
<svelte:head>
	<title>𝙏 𝙀 𝙎 𝙏 𝙓​</title>
	<meta
		name="description"
		content="Empowering Future Testers: A Comprehensive Software Testing Education Platform 🔥.
  "
	/>
</svelte:head>
...
<div class="mx-5 my-10 text-center">
	<h1 class="text-xl leading-8 font-semibold text-black">
